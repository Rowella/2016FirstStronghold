...
import org.usfirst.frc.team4729.robot.commands.LEDBlue;
import org.usfirst.frc.team4729.robot.commands.LEDCycle;
import org.usfirst.frc.team4729.robot.commands.LEDGreen;
import org.usfirst.frc.team4729.robot.commands.LEDMovement;
import org.usfirst.frc.team4729.robot.commands.LEDRed;
...
import org.usfirst.frc.team4729.robot.commands.WinchOut;
...
//    Button l32           = new JoystickButton(xbox2,      9);
  //  Button r32           = new JoystickButton(xbox2,      10);
    ...
    public OI() {
    	...
    	rightButton3.whileHeld  (new LEDGreen());
    	rightButton4.whileHeld  (new LEDRed());
    	rightButton5.whileHeld  (new LEDBlue());
